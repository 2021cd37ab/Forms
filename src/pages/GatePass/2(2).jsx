...
<div className='group'>
           ...
           <div> <select className='select-box' id='type'>
              <option id='outside' defaultValue={'Outside'}  selected>OUTSIDE</option> </select></div>
        ...
        <div className="group">
          <div className="select">
            ...
            <input className='select-box'   id='driver_name' />
          </div>
...
<div className="group">
  <div className="select">
    <div className="label">Truck Number : </div>
     <input className='select-box'   id='truck_number' />
  </div>
...
<div className="group">
  <div className="select">
    <div className="label">Remark : </div>
     <input className='select-box'   id='remark' />
  </div>
